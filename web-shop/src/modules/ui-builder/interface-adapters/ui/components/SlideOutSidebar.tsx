...
export function SlideOutSidebar({ isOpen, onClose, appId, isAdmin = false }: SlideOutSidebarProps) {
  ...
  const navItems = [
    ...
    {
      label: 'Daily Rewards',
      href: `/daily-rewards?appId=${appId}`,
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: 'Daily Rewards Demo',
      href: '/daily-rewards-demo',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-6 border-b border-gray-800">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-white text-xl font-semibold">Web Shop</h1>
            </div>
          </div>
